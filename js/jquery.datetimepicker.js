	...
	dp.append(
		$('<div/>').addClass('timepicker').append(
			$('<div/>').addClass('ui-custom-datetimepicker-hour-pane ui-datepicker-inline ui-datepicker ui-widget  ui-helper-clearfix ui-corner-right').append(
				$('<div/>').addClass('ui-datepicker-header ui-widget-header ui-helper-clearfix ui-corner-all').append(
					$('<div/>').addClass('ui-custom-datetimepicker-header').append(
				...
				$('<div/>').addClass('sliders-panel').append(
					$('<div/>').append('<div id="hour-slider" style="height:125px; margin:1em;"></div>')).append(
					$('<div/>').append('<div id="min-slider" style="height:125px;margin:1em;"></div>')))))
	$('body').append(dp);
	return dp;
}
